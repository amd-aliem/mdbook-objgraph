...
/// Wider horizontal gap used between sibling nodes whose domain requires
/// corridor space for intra-domain bracket edge routing.
pub const NODE_H_SPACING_CORRIDOR: f64 = 60.0;
